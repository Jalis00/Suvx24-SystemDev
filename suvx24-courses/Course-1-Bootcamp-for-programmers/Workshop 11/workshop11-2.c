...
int main() {
    ...
    printf("\nTest's address as integer = %u", &test);   // Which format specifier to use?
    // Print the address of test variable in hexadecimal format
    printf("\nTest's address in hexadecimal format = %p", &test);   // Which format specifier to use?

    pInt = &test;
    // Print the value of pInt variable
    printf("\npInt's value = %i", *pInt);
    // Print the address of pInt variable
    printf("\npInt's address as integer = %u", &pInt); 
